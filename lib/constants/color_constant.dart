...
class ColorConstant {
  ...
  static Color redColor = Color(0xFFD23B30);
  static Color lightTextColor = Color(0xff5B5B5B);
  static Color lightTextColor2 = Color(0xff6C7278);
  static Color borderColor = Color(0xffE2E2E2);
  static Color primaryColor = Color(0xffD23B30);
  static Color primaryColorLighter = Color(0xffFFD5D2);
