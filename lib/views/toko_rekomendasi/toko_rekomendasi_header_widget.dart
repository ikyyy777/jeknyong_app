...
class TokoRekomendasiHeaderWidget extends StatelessWidget {
  const TokoRekomendasiHeaderWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        SizedBox(width: scaleHelper.scaleWidth(40)), // To balance the back button
      ],
    );
  }
}
