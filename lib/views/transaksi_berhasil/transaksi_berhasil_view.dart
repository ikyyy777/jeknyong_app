...
class TransaksiBerhasilView extends StatefulWidget {
  const TransaksiBerhasilView({super.key});

  @override
  State<TransaksiBerhasilView> createState() => _TransaksiBerhasilViewState();
}

class _TransaksiBerhasilViewState extends State<TransaksiBerhasilView>
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text(
                "Proses penjemputan sampah akan dilakukan sesuai jadwal penjemputan maksimal adalah 2x24 Jam dihari kerja Kecuali hari Minggu",
