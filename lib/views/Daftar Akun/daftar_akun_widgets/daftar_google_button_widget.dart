...
class DaftarGoogleButtonWidget extends StatefulWidget {
  const DaftarGoogleButtonWidget({super.key});

  @override
  State<DaftarGoogleButtonWidget> createState() =>
      _DaftarGoogleButtonWidgetState();
}

class _DaftarGoogleButtonWidgetState extends State<DaftarGoogleButtonWidget> {
